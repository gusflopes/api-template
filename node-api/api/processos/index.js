...
const controller = require('./processos.controller');
...
router.get('/join/', VerifyToken, NewToken, controller.join_index);

router.get('/', VerifyToken, NewToken, controller.index);
router.get('/:id', VerifyToken, NewToken, controller.retrieve);
